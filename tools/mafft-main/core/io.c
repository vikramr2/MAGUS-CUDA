...
//				fprintf( stderr, "done\n" );
		...
		else if( *pt1 != '-' && *pt2 != '-' )
		{
			...
			score += (double)n_dis[(int)amino_n[(unsigned char)*pt1]][(int)amino_n[(unsigned char)*pt2]]; // - offset �Ϥ���ʤ�����
//			fprintf( stderr, "%c-%c, score(0) = %f\n", *pt1, *pt2, score );
		}
		if( *pt1++ != '-' ) pos1++;
		if( *pt2++ != '-' ) pos2++;
...
//				fprintf( stderr, "done\n" );
		...
		else if( *pt1 != '-' && *pt2 != '-' )
		{
			...
			iscore += n_dis[(int)amino_n[(unsigned char)*pt1]][(int)amino_n[(unsigned char)*pt2]]; // - offset �Ϥ���ʤ�����
...
int myfgets(s, l, fp)  /* l�ʾ�ϡ������ޤ��ɤ����Ф� */
char    s[] ; int l ; FILE *fp ;
{
        int     c = 0, i = 0 ;
